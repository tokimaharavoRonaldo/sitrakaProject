...
class SellController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function($row){
                    ...
                    $html .= '<li><a href="'. action('App\Http\Controllers\SellController@edit', [$row->id]) .'" class="edit-sell"><i class="glyphicon glyphicon-edit"></i>edit</a></li>';
    ...
    public function printInvoice(Request $request, $id)
    {
        if (request()->ajax()) {
            ...
            $sell=Transaction::findOrFail($id);
                ...
                // $invoice_layout_id = 1;
                // $receipt = $this->receiptContent(  $sell->id, $printer_type, $is_package_slip, false, $invoice_layout_id);
                // $receipt = $this->receiptContent(  $sell->id);
    ...
    private function receiptContent(
        ...
        // $receipt_details = $this->getReceiptDetails($transaction_id, $receipt_printer_type);
        $receipt_details = $this->getReceiptDetails($transaction_id);
    ...
    public function getReceiptDetails($transaction_id)
    {
        ...
        // $output = [
        //     'header_text' => 'heade',
        //     'table_product_label' => 'label',
        //     'table_qty_label' => "qty",
        //     'table_unit_price_label' => "price_lable",
        //     'table_subtotal_label' => "subtotal label",
        // ];
        ...
        // //Address
        // $output['address'] = 'addresse';
        // //Shop Contact Info
        // $output['contact'] = '4657687';
        
    
        // //Invoice info
        $output['invoice_no'] = "no";
        // $output['invoice_no_prefix'] = "prefix";
        // $output['shipping_address'] = "address";
